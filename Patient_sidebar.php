                ...
                display: block;
                 ...
                 font-weight: 600; }
                  .logout-btn:hover { 
                    ...
                    <body> 
                        <div class="container"> <!-- SIDEBAR --> <div class="sidebar"> <img src="./uploads/logo.JPG" alt="QuickCare Logo" class="logo-img" style="display:block; margin: 0 auto 10px auto; width:80px; height:80px; border-radius:50%;"> <h2>QuickCare</h2> 
                        <div class="nav">
                             <a href="index.php">Home</a>
                              <a href="patient.php">Dashboard</a>
                               <a href="patient_profile.php">Profile</a> 
                               <a href="view_doctor_patient.php">Doctor Profile</a>
                                <a href="manage_appointments.php">Appointments</a> 
                                <a href="doctor_schedule.php">Doctor Schedule</a> 
                                <a href="patinet_prescriptions.php">Prescriptions</a> 
                                <a href="medicine_reminder.php">Reminder</a> 
