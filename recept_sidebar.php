...
<div class="sidebar">
    ...
    <a href="recep_patient.php" class="<?= ($currentPage == 'recep_patient.php') ? 'active' : '' ?>">Patients Profile</a>

    <a href="recep_doctor.php" class="<?= ($currentPage == 'recep_doctor.php') ? 'active' : '' ?>">Doctors Profile</a>
