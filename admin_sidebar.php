...
<div class="sidebar">
    ...
    <a href="/QuickCare/QuickCare/Admin_report/ViewAppointmentReportList"" class="<?= ($currentPage == '/QuickCare/QuickCare/Admin_report/ViewAppointmentReportList"') ? 'active' : '' ?>">Reports</a>
