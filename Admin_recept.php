...
<div class="sidebar">
  <img src="uploads/logo.JPG" alt="QuickCare Logo" class="logo-img" style="display:block; margin: 0 auto 10px auto; width:80px; height:80px; border-radius:50%;">  
    ...
    <a href="manage_receptionist.php" class="active">Manage Receptionist</a>
...
<div class="main">
    ...
    <div class="filter-container">
        <form method="GET" action="manage_receptionist.php">
        ...
        if(mysqli_num_rows($result) > 0) {
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr>
                    ...
                    <td>".$row['EMAIL']."</td>
                    <td>
                        <button class='action-btn view-btn' onclick='viewReceptionist(".$row['RECEPTIONIST_ID'].")'>View</button>
                        <button class='action-btn edit-btn' onclick='editReceptionist(".$row['RECEPTIONIST_ID'].")'>Edit</button>
                        <button class='action-btn delete-btn' onclick='deleteReceptionist(".$row['RECEPTIONIST_ID'].")'>Delete</button>
                    </td>
                </tr>";
            }
        } else {
...
function viewReceptionist(id) {
    window.location.href = "view_receptionist_details.php?id=" + id;
}
