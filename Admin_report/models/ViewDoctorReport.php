 ...
 */
#[AsAlias("ViewDoctorReport", true)]
#[AsAlias("view_doctor_report", true)]
#[AsEntityListener(event: Events::postPersist, method: 'clearCache', entity: Entity\ViewDoctorReport::class)]
#[AsEntityListener(event: Events::postUpdate, method: 'clearCache', entity: Entity\ViewDoctorReport::class)]
#[AsEntityListener(event: Events::postRemove, method: 'clearCache', entity: Entity\ViewDoctorReport::class)]
#[AsEntityListener(event: Events::postPersist, method: 'updateLastInsertId', entity: Entity\ViewDoctorReport::class)]
#[AsEntityListener(event: Events::preUpdate, method: 'preUpdate', entity: Entity\ViewDoctorReport::class)]
class ViewDoctorReport extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(
        ...
        $this->EntityClass = Entity\ViewDoctorReport::class;
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return $this->sqlFrom ?? "view_doctor_report";
    }
     ...
     */
    public function clearCache(Entity\ViewDoctorReport $row, LifecycleEventArgs $args): void
    {
        // Clear lookup cache
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("ViewDoctorReportList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "ViewDoctorReportView" => $this->language->phrase("View"),
            "ViewDoctorReportEdit" => $this->language->phrase("Edit"),
            "ViewDoctorReportAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getViewUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewDoctorReportView", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDoctorReportView", [$param]);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = BuildUrl("ViewDoctorReportAdd", $param);
        return $this->addMasterUrl($url);
    }
    ...
    public function getEditUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewDoctorReportEdit", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDoctorReportList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDoctorReportEdit", [$param]);
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewDoctorReportAdd", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDoctorReportList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $param = ""): string
    {
        if ($this->UseAjaxActions && IsInfiniteScroll() && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewDoctorReportDelete", $param);
        }
    }
    ...
    public function renderListContent(array|BaseEntity $data, int $totalRecords)
    {
        global $httpContext;
        $container = Container();
        $page = $container->get("ViewDoctorReportList");
        if (is_array($data)) {
    ...
    public function preUpdate(Entity\ViewDoctorReport $row, PreUpdateEventArgs $args): void
    {
    ...
    public function preRemove(Entity\ViewDoctorReport $row, LifecycleEventArgs $args): void
    {
