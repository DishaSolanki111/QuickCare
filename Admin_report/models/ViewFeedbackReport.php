...
/**
 * Table class for view_feedback_report
 */
#[AsAlias("ViewFeedbackReport", true)]
#[AsAlias("view_feedback_report", true)]
#[AsEntityListener(event: Events::postPersist, method: 'clearCache', entity: Entity\ViewFeedbackReport::class)]
#[AsEntityListener(event: Events::postUpdate, method: 'clearCache', entity: Entity\ViewFeedbackReport::class)]
#[AsEntityListener(event: Events::postRemove, method: 'clearCache', entity: Entity\ViewFeedbackReport::class)]
#[AsEntityListener(event: Events::postPersist, method: 'updateLastInsertId', entity: Entity\ViewFeedbackReport::class)]
#[AsEntityListener(event: Events::preUpdate, method: 'preUpdate', entity: Entity\ViewFeedbackReport::class)]
class ViewFeedbackReport extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(
        ...
        $this->TableVar = "view_feedback_report";
        $this->TableName = 'view_feedback_report';
        $this->TableType = "VIEW";
        $this->SortType = 1; // Sort Type
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");
        $this->EntityClass = Entity\ViewFeedbackReport::class;
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // FEEDBACK_ID
        $this->FEEDBACK_ID = $this->Fields['FEEDBACK_ID'];
        $this->FEEDBACK_ID->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
        ...
        // RATING
        $this->RATING = $this->Fields['RATING'];
        $this->RATING->DefaultErrorMessage = $this->language->phrase("IncorrectInteger");
    ...
    public function getFieldDefinitions(): array
    {
        return [
            'FEEDBACK_ID' => [
                'FieldVar' => 'x_FEEDBACK_ID', // Field variable name
                'Param' => 'FEEDBACK_ID', // Field parameter name (Table class property name)
                'PropertyName' => 'feedbackId', // Field entity property name
                'Expression' => '`FEEDBACK_ID`', // Field expression (used in SQL)
                'BasicSearchExpression' => '`FEEDBACK_ID`', // Field expression (used in basic search SQL)
                'Type' => 3, // Field type
                ...
                'VirtualExpression' => '`FEEDBACK_ID`', // Virtual field expression (used in ListSQL)
            ...
            'RATING' => [
                'FieldVar' => 'x_RATING', // Field variable name
                'Param' => 'RATING', // Field parameter name (Table class property name)
                'PropertyName' => 'rating', // Field entity property name
                'Expression' => '`RATING`', // Field expression (used in SQL)
                'BasicSearchExpression' => '`RATING`', // Field expression (used in basic search SQL)
                'Type' => 3, // Field type
                'DataType' => DataType::NUMBER, // Field data type (DataType::XXX)
                'ParameterType' => ParameterType::INTEGER, // Field Doctrine parameter type
                'Size' => 11, // Field size
                'DateTimeFormat' => -1, // Date time format
                'VirtualExpression' => '`RATING`', // Virtual field expression (used in ListSQL)
                'IsVirtual' => false, // Virtual field
                'ForceSelection' => false, // Autosuggest force selection
                'VirtualSearch' => false, // Search as virtual field
                'ViewTag' => 'FORMATTED TEXT', // View Tag
            ...
            'COMMENTS' => [
                'FieldVar' => 'x_COMMENTS', // Field variable name
                'Param' => 'COMMENTS', // Field parameter name (Table class property name)
                'PropertyName' => 'comments', // Field entity property name
                'Expression' => '`COMMENTS`', // Field expression (used in SQL)
                'BasicSearchExpression' => '`COMMENTS`', // Field expression (used in basic search SQL)
                'Type' => 200, // Field type
                'DataType' => DataType::STRING, // Field data type (DataType::XXX)
                'ParameterType' => ParameterType::STRING, // Field Doctrine parameter type
                'Size' => 255, // Field size
                'DateTimeFormat' => -1, // Date time format
                'VirtualExpression' => '`COMMENTS`', // Virtual field expression (used in ListSQL)
                'IsVirtual' => false, // Virtual field
                'ForceSelection' => false, // Autosuggest force selection
                'VirtualSearch' => false, // Search as virtual field
                'ViewTag' => 'FORMATTED TEXT', // View Tag
    ...
    {
        return $this->sqlFrom ?? "view_feedback_report";
    }
     ...
     */
    public function clearCache(Entity\ViewFeedbackReport $row, LifecycleEventArgs $args): void
    {
        // Clear lookup cache
    ...
    protected function loadDbValues(?BaseEntity $row)
    {
        ...
        $this->FEEDBACK_ID->DbValue = $row->getFeedbackId();
        ...
        $this->RATING->DbValue = $row->getRating();
        $this->COMMENTS->DbValue = $row->getComments();
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("ViewFeedbackReportList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "ViewFeedbackReportView" => $this->language->phrase("View"),
            "ViewFeedbackReportEdit" => $this->language->phrase("Edit"),
            "ViewFeedbackReportAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getViewUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewFeedbackReportView", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFeedbackReportView", [$param]);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = BuildUrl("ViewFeedbackReportAdd", $param);
        return $this->addMasterUrl($url);
    }
    ...
    public function getEditUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewFeedbackReportEdit", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFeedbackReportList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFeedbackReportEdit", [$param]);
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewFeedbackReportAdd", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFeedbackReportList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $param = ""): string
    {
        if ($this->UseAjaxActions && IsInfiniteScroll() && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewFeedbackReportDelete", $param);
        }
    }
    ...
    {
        $this->FEEDBACK_ID->setDbValue($row['FEEDBACK_ID']);
    ...
    public function renderListContent(array|BaseEntity $data, int $totalRecords)
    {
        global $httpContext;
        $container = Container();
        $page = $container->get("ViewFeedbackReportList");
        if (is_array($data)) {
    ...
    public function renderListRow()
    {
        ...
        // FEEDBACK_ID
        $this->FEEDBACK_ID->ViewValue = $this->FEEDBACK_ID->CurrentValue;
        ...
        // FEEDBACK_ID
        $this->FEEDBACK_ID->HrefValue = "";
        $this->FEEDBACK_ID->TooltipValue = "";
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->FEEDBACK_ID);
        ...
        while ($recordIndex < count($records) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->FEEDBACK_ID);
    ...
    public function updateLastInsertId(Entity\ViewFeedbackReport $row, LifecycleEventArgs $args)
    {
        $this->FEEDBACK_ID->setDbValue($row['FEEDBACK_ID']);
    }

    // Save entity change set
    public function preUpdate(Entity\ViewFeedbackReport $row, PreUpdateEventArgs $args): void
    {
    ...
    public function preRemove(Entity\ViewFeedbackReport $row, LifecycleEventArgs $args): void
    {
