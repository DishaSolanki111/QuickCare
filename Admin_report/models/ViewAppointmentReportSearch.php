 ...
 * Page class
 */
#[AsAlias("ViewAppointmentReportSearch", true)]
class ViewAppointmentReportSearch extends ViewAppointmentReport implements PageInterface
{
    use MessagesTrait;
    use FormTrait;
    ...
    // CSS class/style
    public string $CurrentPageName = "ViewAppointmentReportSearch"; // Route action
    ...
    public function run(): void
    {
        ...
        if ($this->isSearch()) {
            ...
            if ($srchStr != "") {
                $srchStr = "ViewAppointmentReportList" . "?" . $srchStr;
    ...
    public function renderRow(RowType $rowType = RowType::VIEW, bool $resetAttributes = true): void
    {
        ...
        // APPOINTMENT_TIME
        $this->APPOINTMENT_TIME->RowCssClass = "row";
    ...
    protected function validateSearch(): bool
    {
        ...
        if (!CheckTime($this->APPOINTMENT_TIME->AdvancedSearch->SearchValue, $this->APPOINTMENT_TIME->formatPattern())) {
            $this->APPOINTMENT_TIME->addErrorMessage($this->APPOINTMENT_TIME->getErrorMessage(false));
        }
    ...
    protected function setupBreadcrumb(): void
    {
        ...
        $url = CurrentUrl();
        $breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewAppointmentReportList"), "", $this->TableVar, true);
        $pageId = "search";
