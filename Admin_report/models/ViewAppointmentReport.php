 ...
 */
#[AsAlias("ViewAppointmentReport", true)]
#[AsAlias("view_appointment_report", true)]
#[AsEntityListener(event: Events::postPersist, method: 'clearCache', entity: Entity\ViewAppointmentReport::class)]
#[AsEntityListener(event: Events::postUpdate, method: 'clearCache', entity: Entity\ViewAppointmentReport::class)]
#[AsEntityListener(event: Events::postRemove, method: 'clearCache', entity: Entity\ViewAppointmentReport::class)]
#[AsEntityListener(event: Events::postPersist, method: 'updateLastInsertId', entity: Entity\ViewAppointmentReport::class)]
#[AsEntityListener(event: Events::preUpdate, method: 'preUpdate', entity: Entity\ViewAppointmentReport::class)]
class ViewAppointmentReport extends DbTable implements LookupTableInterface
{
    ...
    public function __construct(
        ...
        $this->EntityClass = Entity\ViewAppointmentReport::class;
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->Doctor_Name->Lookup = new Lookup($this->Doctor_Name, 'view_appointment_report', true, 'Doctor_Name', ["Doctor_Name","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
        ...
        $this->APPOINTMENT_DATE->Lookup = new Lookup($this->APPOINTMENT_DATE, 'view_appointment_report', true, 'APPOINTMENT_DATE', ["APPOINTMENT_DATE","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
        ...
        $this->STATUS->Lookup = new Lookup($this->STATUS, 'view_appointment_report', true, 'STATUS', ["STATUS","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return $this->sqlFrom ?? "view_appointment_report";
    }
     ...
     */
    public function clearCache(Entity\ViewAppointmentReport $row, LifecycleEventArgs $args): void
    {
        // Clear lookup cache
    ...
    protected function loadDbValues(?BaseEntity $row)
    {
        ...
        $this->APPOINTMENT_TIME->DbValue = $row->getAppointmentTime();
        $this->STATUS->DbValue = $row->getStatus();
    }
    ...
    public function getReturnUrl(): string
    {
        ...
        return Session($name) ?? GetUrl("ViewAppointmentReportList");
    }
    ...
    public function getModalCaption(string $pageName): string
    {
        return match ($pageName) {
            "ViewAppointmentReportView" => $this->language->phrase("View"),
            "ViewAppointmentReportEdit" => $this->language->phrase("Edit"),
            "ViewAppointmentReportAdd" => $this->language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "ViewAppointmentReportList";
    }
    ...
    public function getViewUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewAppointmentReportView", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAppointmentReportView", [$param]);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = BuildUrl("ViewAppointmentReportAdd", $param);
        return $this->addMasterUrl($url);
    }
    ...
    public function getEditUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewAppointmentReportEdit", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAppointmentReportList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAppointmentReportEdit", [$param]);
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl(string $param = ""): string
    {
        ...
        $url = $this->keyUrl("ViewAppointmentReportAdd", $params);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAppointmentReportList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl(string $param = ""): string
    {
        if ($this->UseAjaxActions && IsInfiniteScroll() && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewAppointmentReportDelete", $param);
        }
    }
    ...
    public function renderListContent(array|BaseEntity $data, int $totalRecords)
    {
        global $httpContext;
        $container = Container();
        $page = $container->get("ViewAppointmentReportList");
        if (is_array($data)) {
    ...
    public function updateLastInsertId(Entity\ViewAppointmentReport $row, LifecycleEventArgs $args)
    {
        $this->APPOINTMENT_ID->setDbValue($row['APPOINTMENT_ID']);
    }

    // Save entity change set
    public function preUpdate(Entity\ViewAppointmentReport $row, PreUpdateEventArgs $args): void
    {
    ...
    public function preRemove(Entity\ViewAppointmentReport $row, LifecycleEventArgs $args): void
    {
