...
<?= $Page->showFilterList() ?>
<?php if (!$Page->IsModal) { ?>
<form name="fview_doctor_reportsrch" id="fview_doctor_reportsrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="off">
<div id="fview_doctor_reportsrch_search_panel" class="mb-2 mb-sm-0 <?= $Page->SearchPanelClass ?>"><!-- .ew-search-panel -->
<script<?= Nonce() ?>>
var currentTable = <?= json_encode($Page->getClientVars()) ?>;
ew.deepAssign(ew.vars, { tables: { view_doctor_report: currentTable } });
var currentForm;
var fview_doctor_reportsrch, currentSearchForm, currentAdvancedSearchForm;
ew.on("wrapper", () => {
    let $ = jQuery,
...
?>
    <div id="xs_Doctor_Name" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->Doctor_Name->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fview_doctor_reportsrch_x_Doctor_Name"
        ...
        ew.on("fview_doctor_reportsrch", function() {
            let options = {
                name: "x_Doctor_Name",
                selectId: "fview_doctor_reportsrch_x_Doctor_Name",
                ajax: { id: "x_Doctor_Name", form: "fview_doctor_reportsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.view_doctor_report.fields.Doctor_Name.filterOptions);
...
?>
    <div id="xs_Specialisation" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->Specialisation->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fview_doctor_reportsrch_x_Specialisation"
            data-table="view_doctor_report"
        ...
        ew.on("fview_doctor_reportsrch", function() {
            let options = {
                name: "x_Specialisation",
                selectId: "fview_doctor_reportsrch_x_Specialisation",
...
?>
    <div id="xs_APPOINTMENT_DATE" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->APPOINTMENT_DATE->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fview_doctor_reportsrch_x_APPOINTMENT_DATE"
            data-table="view_doctor_report"
        ...
        ew.on("fview_doctor_reportsrch", function() {
            let options = {
                name: "x_APPOINTMENT_DATE",
                selectId: "fview_doctor_reportsrch_x_APPOINTMENT_DATE",
                ajax: { id: "x_APPOINTMENT_DATE", form: "fview_doctor_reportsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.view_doctor_report.fields.APPOINTMENT_DATE.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_Month_Name" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->Month_Name->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fview_doctor_reportsrch_x_Month_Name"
            data-table="view_doctor_report"
        ...
        ew.on("fview_doctor_reportsrch", function() {
            let options = {
                name: "x_Month_Name",
                selectId: "fview_doctor_reportsrch_x_Month_Name",
                ajax: { id: "x_Month_Name", form: "fview_doctor_reportsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.view_doctor_report.fields.Month_Name.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
?>
    <div id="xs_Year" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->Year->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            ...
            data-select2-id="fview_doctor_reportsrch_x_Year"
            data-table="view_doctor_report"
            data-field="x_Year"
        ...
        ew.on("fview_doctor_reportsrch", function() {
            let options = {
                name: "x_Year",
                selectId: "fview_doctor_reportsrch_x_Year",
                ajax: { id: "x_Year", form: "fview_doctor_reportsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.view_doctor_report.fields.Year.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
...
<?php
if (!$Page->Appointment_Status->UseFilter) {
    $Page->SearchColumnCount++;
}
?>
    <div id="xs_Appointment_Status" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->Appointment_Status->UseFilter ? " ew-filter-field" : "" ?>">
        <select
            id="x_Appointment_Status"
            name="x_Appointment_Status[]"
            class="form-control ew-select<?= $Page->Appointment_Status->isInvalidClass() ?>"
            data-select2-id="fview_doctor_reportsrch_x_Appointment_Status"
            data-table="view_doctor_report"
            data-field="x_Appointment_Status"
            data-caption="<?= HtmlEncode(RemoveHtml($Page->Appointment_Status->caption())) ?>"
            data-filter="true"
            multiple
            size="1"
            data-value-separator="<?= $Page->Appointment_Status->displayValueSeparatorAttribute() ?>"
            data-placeholder="<?= HtmlEncode($Page->Appointment_Status->getPlaceHolder()) ?>"
            data-ew-action="update-options"
            <?= $Page->Appointment_Status->editAttributes() ?>>
            <?= $Page->Appointment_Status->selectOptionListHtml("x_Appointment_Status", true) ?>
        </select>
        ...
        ew.on("fview_doctor_reportsrch", function() {
            let options = {
                name: "x_Appointment_Status",
                selectId: "fview_doctor_reportsrch_x_Appointment_Status",
                ajax: { id: "x_Appointment_Status", form: "fview_doctor_reportsrch", limit: ew.FILTER_PAGE_SIZE, data: { ajax: "filter" } }
            };
            options = Object.assign({}, ew.filterOptions, options, ew.vars.tables.view_doctor_report.fields.Appointment_Status.filterOptions);
            ew.createFilter(options);
        });
        </script>
    </div><!-- /.col-sm-auto -->
    ...
    <div class="col-sm-auto px-0 pe-sm-2">
        <div class="ew-basic-search input-group">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "" ? " active" : "" ?>" form="fview_doctor_reportsrch" data-ew-action="search-type"><?= Language()->phrase("QuickSearchAuto") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "=" ? " active" : "" ?>" form="fview_doctor_reportsrch" data-ew-action="search-type" data-search-type="="><?= Language()->phrase("QuickSearchExact") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "AND" ? " active" : "" ?>" form="fview_doctor_reportsrch" data-ew-action="search-type" data-search-type="AND"><?= Language()->phrase("QuickSearchAll") ?></button>
                <button type="button" class="dropdown-item<?= $Page->BasicSearch->getType() == "OR" ? " active" : "" ?>" form="fview_doctor_reportsrch" data-ew-action="search-type" data-search-type="OR"><?= Language()->phrase("QuickSearchAny") ?></button>
            </div>
        </div>
    </div>
...
<?php } ?>
<div id="gmp_view_doctor_report" class="card-body ew-grid-middle-panel <?= $Page->TableContainerClass ?>">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit() || $Page->isMultiEdit()) { ?>
<table id="tbl_view_doctor_reportlist" class="<?= $Page->TableClass ?>"><!-- .ew-table -->
<thead>
...
<?php } ?>
<?php if ($Page->Specialisation->Visible) { // Specialisation ?>
        <th data-name="Specialisation" class="<?= $Page->Specialisation->headerCellClass() ?>"><div id="elh_view_doctor_report_Specialisation" class="view_doctor_report_Specialisation"><?= $Page->renderFieldHeader($Page->Specialisation) ?></div></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->Appointment_Status->Visible) { // Appointment_Status ?>
        <th data-name="Appointment_Status" class="<?= $Page->Appointment_Status->headerCellClass() ?>"><div id="elh_view_doctor_report_Appointment_Status" class="view_doctor_report_Appointment_Status"><?= $Page->renderFieldHeader($Page->Appointment_Status) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_view_doctor_report_Specialisation" class="el_view_doctor_report_Specialisation">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_view_doctor_report_EDUCATION" class="el_view_doctor_report_EDUCATION">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_view_doctor_report_Year" class="el_view_doctor_report_Year">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_view_doctor_report_Appointment_Status" class="el_view_doctor_report_Appointment_Status">
...
<?= $Page->Appointment_Status->getViewValue() ?></span>
    ...
    <?php } ?>
    <?php if ($Page->Total_Patients->Visible) { // Total_Patients ?>
        <td data-name="Total_Patients"<?= $Page->Total_Patients->cellAttributes() ?>>
