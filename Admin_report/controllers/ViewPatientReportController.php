...
/**
 * ViewPatientReport controller
 */
class ViewPatientReportController extends BaseController
{
    // list
    #[Route('/ViewPatientReportList', methods: ['GET', 'POST', 'OPTIONS'], name: 'list.view_patient_report')]
    public function list(Request $request, ViewPatientReportList $page): Response
    {
        // Init page
        $page->init();
