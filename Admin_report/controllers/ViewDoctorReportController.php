...
/**
 * ViewDoctorReport controller
 */
class ViewDoctorReportController extends BaseController
{
    // list
    #[Route('/ViewDoctorReportList/{chartName}', methods: ['GET', 'POST', 'OPTIONS'], name: 'list.view_doctor_report')]
    public function list(Request $request, ViewDoctorReportList $page, ?string $chartName = null): Response
    {
        // Init page
        $page->init();
    ...
    // search
    #[Route('/ViewDoctorReportSearch', methods: ['GET', 'POST', 'OPTIONS'], name: 'search.view_doctor_report')]
    public function search(Request $request, ViewDoctorReportSearch $page): Response
    {
        // Check resolved arguments
        $hasResolved = false;
