 ...
 */
class get_Doctrine_QueryCachePool_TaggableService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
     * Gets the private '.doctrine.query_cache_pool.taggable' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['.doctrine.query_cache_pool.taggable'] = new \Symfony\Component\Cache\Adapter\TagAwareAdapter(($container->privates['doctrine.query_cache_pool'] ?? self::getDoctrine_QueryCachePoolService($container)));
    }
}
