 ...
 */
class getMailer_TransportsService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = (new \Symfony\Component\Mailer\Transport(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->services['PHPMaker2026\\Project2\\EsmtpTransportFactoryDecorator'] ?? $container->load('getEsmtpTransportFactoryDecoratorService'));
