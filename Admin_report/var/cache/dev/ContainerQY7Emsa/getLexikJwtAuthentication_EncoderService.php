 ...
 */
class getLexikJwtAuthentication_EncoderService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['lexik_jwt_authentication.encoder'] = new \Lexik\Bundle\JWTAuthenticationBundle\Encoder\LcobucciJWTEncoder(new \Lexik\Bundle\JWTAuthenticationBundle\Services\JWSProvider\LcobucciJWSProvider(($container->services['lexik_jwt_authentication.key_loader'] ?? $container->load('getLexikJwtAuthentication_KeyLoaderService')), $container->getEnv('JWT_ALGORITHM'), $container->getEnv('JWT_EXPIRY_TIME'), $container->getEnv('int:JWT_CLOCK_SKEW'), false));
    }
}
