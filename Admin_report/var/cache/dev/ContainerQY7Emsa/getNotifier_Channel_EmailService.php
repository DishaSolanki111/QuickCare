 ...
 */
class getNotifier_Channel_EmailService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Notifier\Channel\EmailChannel($a, NULL, NULL);

        if (isset($container->privates['notifier.channel.email'])) {
            return $container->privates['notifier.channel.email'];
        }

        return $container->privates['notifier.channel.email'] = $instance;
    }
}
