 ...
 */
class getSecurity_User_Provider_Concrete_2faUsersService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.user.provider.concrete.2fa_users' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.2fa_users'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(new RewindableGenerator(fn () => new \EmptyIterator(), 0));
    }
}
