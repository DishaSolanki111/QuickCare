 ...
 */
class getConsole_Command_CachePoolInvalidateTagsService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_invalidate_tags'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolInvalidateTagsCommand(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'doctrine.metadata_cache_pool' => ['privates', '.doctrine.metadata_cache_pool.taggable', 'get_Doctrine_MetadataCachePool_TaggableService', true],
            ...
            'doctrine.query_cache_pool' => ['privates', '.doctrine.query_cache_pool.taggable', 'get_Doctrine_QueryCachePool_TaggableService', true],
        ], [
            ...
            'doctrine.metadata_cache_pool' => 'Symfony\\Component\\Cache\\Adapter\\TagAwareAdapter',
            'doctrine.result_cache_pool' => 'Symfony\\Component\\Cache\\Adapter\\TagAwareAdapter',
            'doctrine.query_cache_pool' => 'Symfony\\Component\\Cache\\Adapter\\TagAwareAdapter',
        ]));
