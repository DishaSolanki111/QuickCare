 ...
 */
class getExerciseHtmlPurifier_DefaultService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['exercise_html_purifier.default'] = new \HTMLPurifier(\Exercise\HTMLPurifierBundle\HTMLPurifierConfigFactory::create('default', ['Cache.SerializerPath' => (\dirname(__DIR__, 4).'/var/cache/htmlpurifier'), 'Cache.SerializerPermissions' => 493], NULL, [], [], [], []));
    }
}
