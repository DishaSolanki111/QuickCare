 ...
 */
class getNotifier_Channel_SmsService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Notifier\Channel\SmsChannel($a, NULL);

        if (isset($container->privates['notifier.channel.sms'])) {
            return $container->privates['notifier.channel.sms'];
        }

        return $container->privates['notifier.channel.sms'] = $instance;
    }
}
