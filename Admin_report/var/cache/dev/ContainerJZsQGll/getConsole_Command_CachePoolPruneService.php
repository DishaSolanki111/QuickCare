 ...
 */
class getConsole_Command_CachePoolPruneService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'doctrine.metadata_cache_pool' => ($container->privates['doctrine.metadata_cache_pool'] ?? self::getDoctrine_MetadataCachePoolService($container));
            ...
            yield 'doctrine.query_cache_pool' => ($container->privates['doctrine.query_cache_pool'] ?? self::getDoctrine_QueryCachePoolService($container));
        }, 5));
