 ...
 */
class getCacheWarmerService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->services['PHPMaker2026\\Project2\\LanguageCacheWarmer'] ?? $container->load('getLanguageCacheWarmerService'));
        ...
        }, 9), true, ($container->targetDir.''.'/PHPMaker2026_Project2_KernelDevDebugContainerDeprecations.log'));
    }
}
