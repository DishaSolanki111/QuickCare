 ...
 */
class get_Lazy_DataCollector_DumpService extends PHPMaker2026_Project2_KernelDevDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['.lazy.data_collector.dump'] = $container->createProxy('DumpDataCollectorProxyDab9a6a', static fn () => \DumpDataCollectorProxyDab9a6a::createLazyProxy(static fn () => self::do($container, false)));
        }
